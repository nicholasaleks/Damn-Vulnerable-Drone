...
def stage1():
    ...
    command = "Tools/autotest/sim_vehicle.py -v ArduCopter --add-param-file drone.parm --custom-location 37.241861,-115.796917,0,340 -f gazebo-iris --no-rebuild --no-mavproxy --sim-address=10.13.0.5 -A '--serial0=uart:/dev/ttyACM0:57600'"
